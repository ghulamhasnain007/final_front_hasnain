      ...
      <div style={{ margin: '20px auto', maxWidth: '800px' }}>
        {isLoadingTask ? (
          ...
          <>
            ...
            <Card title={`Teacher Name: ${task.teacher_name}`} style={{ borderRadius: "13px 31px 50px 12px", boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', backgroundColor: '#ffffff' }}>
              <Card type="inner" title={`Last Date of Assignment: ${task.last_date?.slice(0, 10) || 'N/A'}`} style={{ borderRadius: "13px 31px 50px 12px", marginBottom: '20px' }}>
